...
export default async function InfluencersPage() {
  ...
  if (!publicView && !currentUser) {
    return (
      <MembersOnlyGate
        next="/influenszerek"
        title="Az influenszerek böngészése csak tagoknak elérhető"
        description="Regisztrálj ingyen, és máris böngészheted a magyar influenszereket, vagy lépj be a fiókodba."
      />
    );
  }
